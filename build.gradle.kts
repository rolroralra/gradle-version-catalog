...
publishing {
    ...
    repositories {
        maven {
            ...
            credentials {
                username = project.findProperty("repo.user") as String? ?: System.getenv("REPO_USERNAME")
                password = project.findProperty("repo.token") as String? ?: System.getenv("REPO_TOKEN")
            }
        }
    }
}
